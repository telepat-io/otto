...
- A running Otto relay (`otto start`). See [Installation](../installation.md) if you haven't set that up yet.
...
Nodes that appear here are both connected to the relay and have granted your controller ACL access. If the list is empty, see the [Pairing](../pairing-auth.md) guide.
...
- [Error Codes](../error-codes.md) — relay error codes you may encounter
